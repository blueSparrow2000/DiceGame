...
### icons / buff icons
icons = ['no op','shield','attack','buff','unknown','regen','absorption', 'summon', 'infiltrate', 'poison', 'toxin','healall' ,'lifesteal','charge','death'] #  enemy가 사용하니까 추가할때 이름을 주의하라 (enemy의 기술 명으로 해야함)
