...
# # sound effects
sound_effect_list = ['bell','confirm','dash','drink','fist','get','hard_hit','hit','item_put_down','lazer','playerdeath','sword','water', 'break' ,'block', 'blast', 'shruff', 'small_hit', 'horn_low','horn_high','jackpot','coin_drop','register', 'bandage', 'railgun_reload']
############## not needed ###############
