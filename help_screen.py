...
def help_screen(screen,clock):
    ...
    while game_run:
        ...
        if help_page_idx==0:
            ...
            write_text_description(screen, width // 2, tile_explanation_location[1] + 170, "You can sell relics for low price or buy higher tier relics", 17, requirement_shown = False)
